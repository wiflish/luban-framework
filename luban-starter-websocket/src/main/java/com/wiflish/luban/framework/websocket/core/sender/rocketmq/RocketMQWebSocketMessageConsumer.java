package com.wiflish.luban.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${luban.framework.websocket.sender-rocketmq.topic}",
        consumerGroup = "${luban.framework.websocket.sender-rocketmq.consumer-group}",
