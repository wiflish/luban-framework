package com.wiflish.luban.framework.desensitize.core;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("wiflish");
        ...
        desensitizeDemo.setRegex("你好，我是wiflish");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("wiflish");
        ...
        assertEquals("wiflish", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "wiflish", replacer = "*")
