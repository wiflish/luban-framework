 ...
 * @since 2024-07-31
 */
public class XenditVABNIPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.XENDIT_VA_BNI.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.XENDIT_VA_BNI.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return XenditVABNIPayClient.class;
    }
