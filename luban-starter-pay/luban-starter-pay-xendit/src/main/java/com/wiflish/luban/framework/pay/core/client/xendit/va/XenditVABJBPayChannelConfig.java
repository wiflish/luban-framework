 ...
 * @since 2024-07-31
 */
public class XenditVABJBPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.XENDIT_VA_BJB.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.XENDIT_VA_BJB.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return XenditVABJBPayClient.class;
    }
