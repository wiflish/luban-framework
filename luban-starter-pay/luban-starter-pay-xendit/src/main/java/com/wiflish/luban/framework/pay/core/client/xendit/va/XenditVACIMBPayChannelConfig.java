 ...
 * @since 2024-07-31
 */
public class XenditVACIMBPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.XENDIT_VA_CIMB.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.XENDIT_VA_CIMB.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return XenditVACIMBPayClient.class;
    }
