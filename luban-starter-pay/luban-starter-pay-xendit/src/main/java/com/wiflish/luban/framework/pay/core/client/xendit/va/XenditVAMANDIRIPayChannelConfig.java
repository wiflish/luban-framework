 ...
 * @since 2024-07-31
 */
public class XenditVAMANDIRIPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.XENDIT_VA_MANDIRI.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.XENDIT_VA_MANDIRI.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return XenditVAMANDIRIPayClient.class;
    }
