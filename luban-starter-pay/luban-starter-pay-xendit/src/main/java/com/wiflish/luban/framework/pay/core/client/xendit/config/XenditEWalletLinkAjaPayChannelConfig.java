 ...
 * @since 2024-07-30
 */
public class XenditEWalletLinkAjaPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.XENDIT_E_WALLET_LINKAJA.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.XENDIT_E_WALLET_LINKAJA.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return XenditEWalletLinkAjaPayClient.class;
    }
