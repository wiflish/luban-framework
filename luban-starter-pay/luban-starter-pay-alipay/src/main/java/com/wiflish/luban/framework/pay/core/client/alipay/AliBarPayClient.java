package com.wiflish.luban.framework.pay.core.client.alipay;
...
import static com.wiflish.luban.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.wiflish.luban.framework.common.exception.util.ServiceExceptionUtil.exception0;
 ...
 */
@Slf4j
public class AliBarPayClient extends AbstractAliPayClient {

    public AliBarPayClient(Long channelId, AliPayClientConfig config) {
    ...
    public PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws AlipayApiException {
        ...
        if (Objects.equals(config.getMode(), AliPayClientConfig.MODE_CERTIFICATE)) {
            // 证书模式
