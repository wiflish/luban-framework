 ...
 * @since 2024-08-12
 */
public class EzeelinkVADanamonPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.EZEELINK_VA_DANAMON.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.EZEELINK_VA_DANAMON.getName();
    }
