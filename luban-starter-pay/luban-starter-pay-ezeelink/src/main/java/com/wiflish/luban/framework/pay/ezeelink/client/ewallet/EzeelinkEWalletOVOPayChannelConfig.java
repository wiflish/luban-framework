 ...
 * @since 2024-08-08
 */
public class EzeelinkEWalletOVOPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.EZEELINK_E_WALLET_OVO.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.EZEELINK_E_WALLET_OVO.getName();
    }

    @Override
    public Class<? extends PayClient> getPayClient() {
        return EzeelinkEWalletOVOPayClient.class;
    }
