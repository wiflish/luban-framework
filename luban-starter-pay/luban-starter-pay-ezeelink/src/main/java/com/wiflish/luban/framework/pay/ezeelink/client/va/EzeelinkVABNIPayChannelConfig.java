 ...
 * @since 2024-08-12
 */
public class EzeelinkVABNIPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.EZEELINK_VA_BNI.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.EZEELINK_VA_BNI.getName();
    }
