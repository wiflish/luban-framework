 ...
 * @since 2024-08-08
 */
public class EzeelinkEWalletDANAPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.EZEELINK_E_WALLET_DANA.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.EZEELINK_E_WALLET_DANA.getName();
    }
