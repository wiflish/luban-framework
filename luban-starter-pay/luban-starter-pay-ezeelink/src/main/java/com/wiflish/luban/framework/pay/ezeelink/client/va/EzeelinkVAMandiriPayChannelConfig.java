 ...
 * @since 2024-08-12
 */
public class EzeelinkVAMandiriPayChannelConfig implements PayChannelConfig {
    @Override
    public String getChannelCode() {
        return PayChannelEnum.EZEELINK_VA_MANDIRI.getCode();
    }

    @Override
    public String getChannelName() {
        return PayChannelEnum.EZEELINK_VA_MANDIRI.getName();
    }
