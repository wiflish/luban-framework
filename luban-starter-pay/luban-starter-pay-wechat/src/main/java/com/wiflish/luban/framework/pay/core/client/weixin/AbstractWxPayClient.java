...
import com.wiflish.luban.framework.common.util.io.FileUtils;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            return switch (config.getApiVersion()) {
                case WxPayClientConfig.API_VERSION_V2 -> doUnifiedOrderV2(reqDTO);
    ...
    protected WxPayUnifiedOrderRequest buildPayUnifiedOrderRequestV2(PayOrderUnifiedReqDTO reqDTO) {
        return WxPayUnifiedOrderRequest.newBuilder()
                ...
                .totalFee(Optional.of(reqDTO.getPrice()).orElse(null).intValue()) // 单位分
    ...
    protected WxPayUnifiedOrderV3Request buildPayUnifiedOrderRequestV3(PayOrderUnifiedReqDTO reqDTO) {
        ...
        request.setAmount(new WxPayUnifiedOrderV3Request.Amount().setTotal(Optional.of(reqDTO.getPrice()).orElse(null).intValue())); // 单位分
    ...
    protected PayOrderRespDTO doGetOrder(String outTradeNo) throws Throwable {
        try {
            return switch (config.getApiVersion()) {
                case WxPayClientConfig.API_VERSION_V2 -> doGetOrderV2(outTradeNo);
    ...
    protected PayRefundRespDTO doUnifiedRefund(PayRefundUnifiedReqDTO reqDTO) throws Throwable {
        try {
            return switch (config.getApiVersion()) {
                case WxPayClientConfig.API_VERSION_V2 -> doUnifiedRefundV2(reqDTO);
    ...
    private PayRefundRespDTO doUnifiedRefundV2(PayRefundUnifiedReqDTO reqDTO) throws Throwable {
        ...
        WxPayRefundRequest request = new WxPayRefundRequest()
                ...
                .setRefundFee(Optional.of(reqDTO.getRefundPrice()).orElse(null).intValue())
                .setRefundDesc(reqDTO.getReason())
                .setTotalFee(Optional.of(reqDTO.getPayPrice()).orElse(null).intValue())
    ...
    private PayRefundRespDTO doUnifiedRefundV3(PayRefundUnifiedReqDTO reqDTO) throws Throwable {
        ...
        WxPayRefundV3Request request = new WxPayRefundV3Request()
                .setOutTradeNo(reqDTO.getOutTradeNo())
                .setOutRefundNo(reqDTO.getOutRefundNo())
                .setAmount(new WxPayRefundV3Request.Amount().setRefund(Optional.of(reqDTO.getRefundPrice()).orElse(null).intValue())
                        .setTotal(Optional.of(reqDTO.getPayPrice()).orElse(null).intValue()).setCurrency("CNY"))
    ...
    protected PayRefundRespDTO doGetRefund(String outTradeNo, String outRefundNo) throws WxPayException {
        try {
            return switch (config.getApiVersion()) {
                case WxPayClientConfig.API_VERSION_V2 -> doGetRefundV2(outTradeNo, outRefundNo);
